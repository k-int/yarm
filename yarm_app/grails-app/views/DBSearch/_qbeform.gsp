...
<g:else>
  <form method="get" class="form-horizontal" role="form" id="__dbsearchForm">
	        ...
	        <g:if test="${fld.type=='lookup'}">
  	        ...
  	        <g:else>
                    <div class="${fld.contextTree.wildcard!=null?'input-group':''}">
                      ...
                      <input class="form-control qfld" type="text" name="${fld.qparam}" id="${fld.qparam}" placeholder="${fld.placeholder}" value="${params[fld.qparam]}" />
          ...
          <g:else>
            <div class="btn-group pull-right" role="group" aria-label="Search Buttons">
              ...
              <g:if test="${params.newResourceMapping}">
                <g:link class="btn btn-success btn-sm" mapping="${params.newResourceMapping}" params="${params}" id="__new__">New</g:link>
              </g:if>
              <!--
