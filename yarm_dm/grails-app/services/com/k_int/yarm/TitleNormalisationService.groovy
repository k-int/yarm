...
class TitleNormalisationService {
  ...
  public static String generateComponentHash(String component_string) {
    return MessageDigest.getInstance("MD5").digest(component_string.bytes).encodeHex().toString()
  }
